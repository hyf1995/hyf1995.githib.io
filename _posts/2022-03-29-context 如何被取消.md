...
先看一张整体的图：
![image.png](https://cdn.nlark.com/yuque/0/2023/png/23194955/1688370287106-17288113-b369-44d3-8518-247cef4e03e4.png#averageHue=%23ecebeb&clientId=u68f292d9-bf91-4&from=paste&height=509&id=u67f93588&originHeight=824&originWidth=524&originalType=binary&ratio=2&rotation=0&showTitle=false&size=164450&status=done&style=none&taskId=u8a6dd189-82d2-47ff-adaf-c803420a2ce&title=&width=324)
...
整体类图如下：
![image.png](https://cdn.nlark.com/yuque/0/2023/png/23194955/1688370481119-012665fa-3641-4455-9b40-fc8a52e0a199.png#averageHue=%23f5f5f5&clientId=u68f292d9-bf91-4&from=paste&height=986&id=ua72bea4b&originHeight=986&originWidth=1596&originalType=binary&ratio=2&rotation=0&showTitle=false&size=123502&status=done&style=none&taskId=u558b56ed-c7cb-42a5-b8ef-0967a6b0f0f&title=&width=1596)
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/23194955/1688373702973-19f9f59c-2c8c-46c7-b4c2-6d6dd7038678.png#averageHue=%23f8ede4&clientId=u68f292d9-bf91-4&from=paste&height=758&id=u1dc2cfed&originHeight=758&originWidth=2248&originalType=binary&ratio=2&rotation=0&showTitle=false&size=101668&status=done&style=none&taskId=u982303d4-d9b7-43d0-b777-c9b45600131&title=&width=2248)如上左图，代表一棵 context 树。当调用左图中标红 context 的 cancel 方法后，该 context 从它的父 context 中去除掉了：实线箭头变成了虚线。且虚线圈框出来的 context 都被取消了，圈内的 context 间的父子关系都荡然无存了。
重点看 propagateCancel()：
```go
...
其实不然。我们来看 parentCancelCtx 的代码：（除以下几个类型以外，拿不到 ok 值，但又可以取消，比如 结构体中包含了一个可以取消的 ctx）
```go
